"""run_sample_eval_v3.py — Evaluate v3 baseline_rag on sample_corpus + test_set_34.

v3 changes: Phase 1 patches A+B+C+D+G (sanitize / PII / SYSTEM_PROMPT / Spotlighting).

Imports build_index / retrieve / generate_answer from local v3 baseline_rag.
Reuses sample_corpus + sample_test_set from ../tech-starterkit/ (same data).
Saves submission_sample_v3.csv compatible with sample_test_set/score.py.

Usage (from tech-starterkit_v3/):
    python run_sample_eval_v3.py
"""
...
OUTPUT_PATH   = "submission_sample_v3.csv"
